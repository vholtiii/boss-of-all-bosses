  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-3 space-y-3">
        ...
        >
          <div className="space-y-1.5">
            {/* Family Power moved to standalone block above */}
            <ActionButton
            ...
            {gameState.plannedHit && (() => {
              ...
              const isTacticalStep = phase !== 'waiting';
              return (
                <div className={cn(
  ...
  return (
    <div className="h-full flex flex-col">
      <ScrollArea className="flex-1">
        ...
        {/* ── Game Analysis (what went wrong, what's left on the table) ── */}
        <GameAnalysisPanel gameState={gameState} onFocusHex={onFocusHex} />
        ...
        {/* ── Supply Ledger ── */}
        {(gameState as any).supplyNodes && (gameState as any).supplyNodes.length > 0 && onAction && (
          <CollapsibleSection
            title="Supply Ledger"
          ...
          >
            <SupplyLedgerPanel
              gameState={gameState}
              onAction={onAction}
              onHighlightSupplyNode={onHighlightSupplyNode}
              highlightedSupplyHex={highlightedSupplyHex}
              embedded
            />
          </CollapsibleSection>
        )}
