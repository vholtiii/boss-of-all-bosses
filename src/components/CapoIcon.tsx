...
const CapoIcon: React.FC<CapoIconProps> = ({ 
  x, y, family, name, level, isPlayerFamily = false, onClick 
}) => {
  ...
  return (
    ...
    >
      {/* Family color glow */}
      <circle cx={x} cy={y + 2} r={size / 2 + 3} fill={familyColor} opacity="0.3" />
      ...
      <image
        ...
        width={size}
        height={size * 1.4}
        style={{ filter: `drop-shadow(0 0 4px ${familyColor})` }}
      />
