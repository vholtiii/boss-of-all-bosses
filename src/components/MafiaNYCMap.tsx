...
const MafiaNYCMap: React.FC<MafiaNYCMapProps> = ({ 
  ...
  // Simplified borough boundaries (in a real app, you'd use actual GeoJSON data)
    ...
    const boundaries = {
      'Manhattan': {
        ...
        geometry: {
          ...
          coordinates: [[
            [-74.0479, 40.6829], [-73.9067, 40.7006], [-73.9106, 40.8176], 
            [-73.9759, 40.8065], [-74.0479, 40.6829]
          ]]
        }
      },
      'Brooklyn': {
        ...
        geometry: {
          type: 'Polygon' as const,
          coordinates: [[
            [-74.0479, 40.5707], [-73.8333, 40.5707], [-73.8333, 40.7395], 
            [-74.0479, 40.7395], [-74.0479, 40.5707]
          ]]
        }
      },
      'Queens': {
        ...
        geometry: {
          ...
          coordinates: [[
            ...
            [-73.8333, 40.8007], [-73.8333, 40.5707]
          ]]
        }
      },
      'Bronx': {
        ...
        geometry: {
          type: 'Polygon' as const,
          coordinates: [[
            [-73.9759, 40.8065], [-73.7658, 40.8065], [-73.7658, 40.9176], 
            [-73.9759, 40.9176], [-73.9759, 40.8065]
          ]]
        }
      },
      'Staten Island': {
        ...
        geometry: {
          type: 'Polygon' as const,
          coordinates: [[
            [-74.2591, 40.4774], [-74.0522, 40.4774], [-74.0522, 40.6518], 
            [-74.2591, 40.6518], [-74.2591, 40.4774]
          ]]
        }
      }
    };
